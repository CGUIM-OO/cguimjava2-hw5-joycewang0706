...
public abstract class Person {
	//5ª`·N: Person.java¤¤¡A¦³¤@setOneRoundCard()¡A¬°oneRoundCard¤§setter¡A¨Ñ«áÄòµ{¦¡¨Ï¥Î
	...
	/*	ª`·N: Person.java¤¤¡A¦³¤@printAllCard()¡A¨Ñ«áÄòµ{¦¡¨Ï¥Î
	„X	´£¥Ü: Dealer.java¤]¬OÄ~©ÓPerson¡A¥i°Ñ¦Ò¨Ï¥Î*/
